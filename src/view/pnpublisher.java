 ...
 * @author Uygi
 */
public class pnpublisher extends javax.swing.JPanel {

    /**
     * Creates new form pnpublisher
     */
    public pnpublisher() {
        initComponents();
        showAllPublisher();
    ...
    public void showAllPublisher() {
        ...
        DefaultTableModel dtm = (DefaultTableModel) tblpub.getModel();
        dtm.setRowCount(0);
    ...
    public void pickAPublisher() {
        tblpub.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                int rowSelected = tblpub.getSelectedRow();
                txtid.setText(Integer.toString((int) tblpub.getValueAt(rowSelected, 0)));
                txtname.setText((String) tblpub.getValueAt(rowSelected, 1));
                txtdescription.setText((String) tblpub.getValueAt(rowSelected, 2));
            }
    ...
    private void initComponents() {
        ...
        pnpublisher.setPreferredSize(new java.awt.Dimension(767, 544));

        tblpub.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        Publisherdao pdao = new Publisherdao();
        if(pdao.addNewPublisher(Integer.parseInt(txtid.getText()), txtname.getText(), txtdescription.getText())) {
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        // TODO add your handling code here:
        Publisherdao pdao = new Publisherdao();
        if(pdao.updatePublisher(Integer.parseInt(txtid.getText()), txtname.getText(), txtdescription.getText())) {
    ...
    private void btndelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndelActionPerformed
        // TODO add your handling code here:
        Publisherdao pdao = new Publisherdao();
        if(pdao.delPublisher(Integer.parseInt(txtid.getText()))) {
    ...
    private void txtidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtidKeyPressed
        ...
        if(evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
            if(txtid.getText().equals("")) {
                ...
                lstp = pdao.getAllPublisherByid(Integer.parseInt(txtid.getText()));
                DefaultTableModel dtm = (DefaultTableModel) tblpub.getModel();
                dtm.setRowCount(0);
                for(Publisher p : lstp ) {
                    Vector vt = new Vector();
    ...
    private void txtnameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnameKeyPressed
        ...
        if(evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
            if(txtname.getText().equals("")) {
                ...
                lstp = pdao.getPublisherByName(txtname.getText());
                DefaultTableModel dtm = (DefaultTableModel) tblpub.getModel();
                dtm.setRowCount(0);
                for(Publisher p : lstp ) {
                    Vector vt = new Vector();
    ...
    public ArrayList<Publisher> lstp = null;

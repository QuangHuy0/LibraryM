...
public class pncategory extends javax.swing.JPanel {
    ...
    public void pickACat() {
        tblcat.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                int rowSelected = tblcat.getSelectedRow();
                txtid.setText(Integer.toString((int) tblcat.getValueAt(rowSelected, 0)));
                txtname.setText((String) tblcat.getValueAt(rowSelected, 1));
                txtdescription.setText((String) tblcat.getValueAt(rowSelected, 2));
            }
    ...
    private void initComponents() {
        ...
        pncategory.setPreferredSize(new java.awt.Dimension(767, 544));

        tblcat.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        pndescriptionLayout.setHorizontalGroup(
            ...
            .addGroup(pndescriptionLayout.createSequentialGroup()
                .addComponent(lbldescription, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE)
                .addGap(204, 204, 204))
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(pncategory, javax.swing.GroupLayout.DEFAULT_SIZE, 773, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
    ...
    private void txtidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtidKeyPressed
        ...
        if(evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
            if(txtid.getText().equals("")) {
                ...
                lstc = cdao.getAllCategoryByid(Integer.parseInt(txtid.getText()));
                DefaultTableModel dtm = (DefaultTableModel) tblcat.getModel();
                dtm.setRowCount(0);
                for(Category c : lstc ) {
                    Vector vt = new Vector();
    ...
    private void txtnameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnameKeyPressed
        ...
        if(evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
            if(txtname.getText().equals("")) {
                ...
                lstc = cdao.getCategoryByName(txtname.getText());
                DefaultTableModel dtm = (DefaultTableModel) tblcat.getModel();
                dtm.setRowCount(0);
                for(Category c : lstc ) {
                    Vector vt = new Vector();
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        // TODO add your handling code here:
        Categorydao cdao = new Categorydao();
        if(cdao.addNewCategory(Integer.parseInt(txtid.getText()), txtname.getText(), txtdescription.getText())) {
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        // TODO add your handling code here:
        Categorydao cdao = new Categorydao();
        if(cdao.updateCategory(Integer.parseInt(txtid.getText()), txtname.getText(), txtdescription.getText())) {
    ...
    private void btndelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndelActionPerformed
        // TODO add your handling code here:
        Categorydao cdao = new Categorydao();
        if(cdao.delCategory(Integer.parseInt(txtid.getText()))) {
